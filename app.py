...
def image_to_excel(input_image_path, output_excel_path, max_size=100):
    try:
        ...
        # Set cell dimensions for square appearance
        ...
        # Map image pixels to Excel cells
            ...
            if file.filename == '':
                ...
                try:
                    ...
                    if grid_size not in [25, 50, 100]:
                        ...
                        if success:
                            return send_file(output_path, as_attachment=True, download_name=f"image_art_{grid_size}x{grid_size}.xlsx")
                        else:
